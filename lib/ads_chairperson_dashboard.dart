...
// --- NEW IMPORT FOR YOUR PERSONAL LOANS ---
                ...
                children: [
                  Expanded(
                    child: _buildQuickActionCard(
                      context,
                      title: 'Loan Requests', // <-- To verify OTHERS' loans
                  ...
                  Expanded(
                    child: _buildQuickActionCard(
                      context,
                      title: 'View Complaints', // <-- Links to the Complaints page we just built
            ...
            Padding(
              ...
              child: GridView.count(
                ...
                children: [
                  ...
                  // --- NEW: LINK TO YOUR PERSONAL LOANS ---
                  _buildModernGridItem(
                    'My Loans', 
        ...
        children: [
          ...
          ListTile(
            ...
            onTap: () {
              ...
              Navigator.push(
                context,
                MaterialPageRoute(builder: (context) => ADSChairpersonSettingsPage(adsId: aadhar)),
              );
            },
          ),
          const Divider(),
